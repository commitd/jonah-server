...
public interface RelationProvider extends DataProvider {
  ...
  default Flux<BaleenRelation> getByExample(
      final RelationProbe probe, final int offset, final int size) {
  ...
  RelationSearchResult search(final RelationSearch search, final int offset, final int size);
}
