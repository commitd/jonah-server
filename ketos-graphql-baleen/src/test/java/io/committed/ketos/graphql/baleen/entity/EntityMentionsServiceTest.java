...
public class EntityMentionsServiceTest extends AbstractKetosGraphqlTest {
  ...
  public void testGetMentionsFromEntity() {
    ...
    BaleenMention mention = new BaleenMention("testMention", 0, 0, "test", "", "value", "eId", "docId", null);
    ...
    postQuery(corpusQuery("entity(id: \"1\"){ mentions { id } }"), defaultVariables())
        .jsonPath("$.data.corpus.entity.mentions").isArray()
        .jsonPath("$.data.corpus.entity.mentions[0].id").isEqualTo("testMention");
  }
