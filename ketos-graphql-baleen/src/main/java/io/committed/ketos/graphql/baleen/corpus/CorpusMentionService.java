...
public class CorpusMentionService extends AbstractGraphQlService {
  ...
  public Mono<BaleenMention> getById(
      @GraphQLContext final BaleenCorpus corpus,
  ...
  public Mono<Long> countMentions(
      @GraphQLContext final BaleenCorpus corpus,
      @GraphQLArgument(
            name = "hints",
            description =
  ...
  public Mono<TermCount> countByField(
    ...
    return BinUtils.joinTermBins(
        getProviders(corpus, MentionProvider.class, hints)
