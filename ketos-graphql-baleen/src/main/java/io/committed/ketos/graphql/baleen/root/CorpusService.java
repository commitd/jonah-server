 ...
 *
 * <p>The corpus is the root of the query tree.
 */
@GraphQLService
public class CorpusService {
  ...
  public Mono<BaleenCorpus> corpus(
      @GraphQLNonNull @GraphQLArgument(name = "id", description = "The corpus id")
          final String id) {
  ...
  private Mono<Boolean> filter(
    ...
    return corpusProviders
        .findForDataset(dataset.getId())
        .any(
            p ->
                (provider == null || provider.equals(p.getProviderType()))
