...
public class RelationSearchService extends AbstractGraphQlService {
  ...
  public Relations getDocuments(@GraphQLContext final RelationSearch search,
    ...
    final Flux<RelationSearchResult> results = getProviders(optionalCorpus.get(), RelationProvider.class, hints)
