...
public class EntityDocumentsService extends AbstractGraphQlService {
  ...
  private final io.committed.ketos.graphql.baleen.corpus.CorpusDocumentsService
      corpusDocumentService;

  @Autowired
  public EntityDocumentsService(
      final DataProviders corpusProviders,
  ...
  public Mono<BaleenDocument> getDocumentForEntity(
      @GraphQLContext final BaleenEntity entity,
      @GraphQLArgument(
            name = "hints",
            description =
    ...
    return corpusDocumentService
        .getDocument(corpus.get(), entity.getDocId(), hints)
