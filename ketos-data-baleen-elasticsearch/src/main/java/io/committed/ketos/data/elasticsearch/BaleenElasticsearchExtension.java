 ...
 *
 * <p>Note this plugin does not use the SpringDataElasticsearch Repository approach we have found
 * this to be too restrictive in the past and generally less clean than writing similar queries in
 * the ElasticserachTemplate. However due to the need for configurability we can't use even
