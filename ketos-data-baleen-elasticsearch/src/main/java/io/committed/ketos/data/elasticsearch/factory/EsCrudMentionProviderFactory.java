...
public class EsCrudMentionProviderFactory
  ...
  public EsCrudMentionProviderFactory(final ObjectMapper mapper) {
    super(
        "baleen-es-crud-mentions",
        CrudMentionProvider.class,
  ...
  @Override
  public Mono<CrudMentionProvider> build(
    ...
    try {
      ...
      return Mono.just(
          new ElasticsearchCrudMentionProvider(
              dataset, datasource, documentType, mentions, relations));
