...
public abstract class AbstractElasticsearchCrudDataProvider<R, T>
    extends AbstractElasticsearchDataProvider implements CrudDataProvider<R, T> {
  ...
  protected boolean delete(
      final ElasticsearchSupportService<?> service, final String docId, final String externalId) {
    return delete(service, docId, BaleenProperties.EXTERNAL_ID, externalId);
  }

  protected boolean delete(
      final ElasticsearchSupportService<?> service,
      final String docId,
