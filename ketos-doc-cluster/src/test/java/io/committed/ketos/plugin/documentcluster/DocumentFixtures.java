...
public final class DocumentFixtures {
  ...
  public static final List<BaleenDocument> DOCUMENTS =
      Arrays.asList(
          BaleenDocument.builder()
              .id("1")
              .content(
          ...
          BaleenDocument.builder()
              .id("3")
              .content("Vladimir Putin wins fourth term as President of Russia")
              .build(),
          BaleenDocument.builder()
              .id("4")
              .content("British scientist Stephen Hawking dies aged 76")
              .build(),
          BaleenDocument.builder()
              .id("5")
              .content("US toy retail giant Toys 'R' Us files for liquidation in United States")
              .build(),
          BaleenDocument.builder()
              .id("6")
              .content(
          ...
          BaleenDocument.builder()
              .id("8")
              .content("United States President Trump dismisses Secretary of State Tillerson")
              .build(),
          BaleenDocument.builder()
              .id("9")
              .content("China ends presidential term limits in constitutional amendment")
              .build());
