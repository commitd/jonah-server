...
public class JpaMetadataProviderFactory extends AbstractJpaDataProviderFactory<MetadataProvider> {
  ...
  public Mono<MetadataProvider> build(final String dataset, final String datasource,
    ...
    return Mono.just(new JpaMetadataProvider(dataset, datasource, metadataRepository));
  }
