...
public class JpaEntityProviderFactory extends AbstractJpaDataProviderFactory<EntityProvider> {
  ...
  public Mono<EntityProvider> build(final String dataset, final String datasource,
    ...
    final JpaEntityRepository repository = support.getRepository(JpaEntityRepository.class);
