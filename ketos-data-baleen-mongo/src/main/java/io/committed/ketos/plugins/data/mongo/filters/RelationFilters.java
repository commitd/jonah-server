...
public final class RelationFilters {
  ...
  public static Optional<Bson> createFilter(
      final Optional<RelationFilter> filter, final boolean operatorMode) {
    ...
    if (relationFilter.getSource() != null) {
      MentionFilters.createFilter(
              Optional.ofNullable(relationFilter.getSource()),
    ...
    if (relationFilter.getTarget() != null) {
      MentionFilters.createFilter(
              Optional.ofNullable(relationFilter.getTarget()),
  ...
  public static Stream<Bson> createFilters(
      final Stream<RelationFilter> filters, final boolean operatorMode) {
    return filters
