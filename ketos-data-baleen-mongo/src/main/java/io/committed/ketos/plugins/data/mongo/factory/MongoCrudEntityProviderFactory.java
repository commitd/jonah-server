...
/** A factory for creating Mongo CrudEntityProviders. */
public class MongoCrudEntityProviderFactory
  ...
  public Mono<CrudEntityProvider> build(
    ...
    return Mono.just(
        new MongoCrudEntityProvider(
            dataset, datasource, database, mentionCollection, collectionName, relationCollection));
  }
}
